...
const questions = [
  {
    question: 'Which of the following statements are true about CNG -Compressed natural gas?',
    answers: [
      { text: 'It is a clean fuel', correct: true },
      { text: 'It is a harmful fuel', correct: false },
      { text: 'It is a polluting fuel', correct: false },
  ...
  },
  {
    ...
    answers: [
      ...
      { text: 'Recycle', correct: true },
    ]
  },
  {
    question: 'Industries require raw materials to be extracted from the ground such minerals cause soil pollution?',
    answers: [
  ...
  {
    question: 'Which of the following helps protect species from extinction?',
    answers: [
      { text: 'All of the above', correct: true },
      { text: 'Conservation efforts', correct: false },
      { text: 'Wildlife refuges', correct: false },
      { text: 'Laws and policies', correct: false }
    ]
  ...
  },
  {
    ...
    answers: [
      ...
      { text: 'Organic materials', correct: false },
  ...
  },
  {
    ...
    answers: [
      { text: 'By the flow of water', correct: false },
      { text: 'By the soil particles', correct: false },
      { text: 'By the action of microorganisms', correct: true },
      { text: 'By oxidation', correct: false }
    ]
    
  },
  {
    question: 'What does the three R  of recycling mean?',
    answers: [
      { text: 'nothing', correct: false },
      { text: 'Reduce Reuse Recycle', correct: true },
      { text: 'reading writing and arithmetic', correct: false },
      { text: 'risk corridors reinsurance and risk adjustment', correct: false }
    ]
    
  },
  {
    question: 'Of the following, which is not a natural disaster ………………..',
    answers: [
      { text: 'Deforestation', correct: false },
      { text: 'Nuclear explosion', correct: true },
  ...
  {
    question: 'Landslides often occur in …………………..',
    answers: [
      { text: 'Nuclear explosion', correct: false },
      { text: 'Hilly region', correct: true },
      { text: 'Tundra region', correct: false },
      { text: 'Desert region', correct: false }
    ]
